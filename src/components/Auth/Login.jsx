        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-linear-to-br from-indigo-800 via-purple-700 to-pink-700 relative overflow-hidden p-6 sm:p-10">
            ...
            <div className="relative z-10 w-full max-w-lg rounded-[2.5rem] border border-white/20 bg-white/10 backdrop-blur-2xl px-10 py-12 md:px-16 md:py-20 shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-500">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-white/60 text-base font-medium">Please enter your details to sign in</p>
                </div>
                ...
                <form onSubmit={SubmitHandler} className="flex flex-col gap-8">
                    ...
                    <div className="flex items-center justify-between text-sm text-white/50 px-4 mt-2">
                        <label className="flex items-center gap-3 cursor-pointer hover:text-white transition">
                            <input type="checkbox" className="w-4 h-4 rounded border-none bg-white/10 checked:bg-pink-500 transition-all" />
                            <span>Remember me</span>
                        </label>
                        <a href="#" className="hover:text-white hover:underline underline-offset-4 font-semibold transition">Forgot password?</a>
                    </div>
